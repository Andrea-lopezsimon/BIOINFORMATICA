...
La lista tiene una 42 secuencias con un alineamiento de longitud 16603pb. Con `names(mtdna)` podemos extarer el nombre de las secuencias y la especie de las que hemos extraído.
:::
...
Nos describe los cuatro elementos de la lista
...
add.scale.bar(mt_nj)= indica la cantidad de cambio evolutivo (distancia genética), es decir, nos ayuda a entender cuanto difieren las secuencias.

axisPhylo(mt_nj)=añade un eje con escala numérica al árbol mostrando valores acumulados de distancia desde la raiz.
